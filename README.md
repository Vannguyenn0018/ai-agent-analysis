...
* **Mục tiêu:** Đánh giá mức độ ứng dụng AI, xác định các "điểm đau" (pain-points) trong công việc và đề xuất giải pháp AI Agent phù hợp.
* **Công cụ sử dụng:** `Python`, `Pandas`, `Matplotlib`, `Seaborn`, `NumPy`, `SciPy` (mstats).
* **Môi trường phát triển:** Workbench, Google Colab, Streamlit, GitHub.
...
### 1. Tiền xử lý & Làm sạch dữ liệu (Data Preprocessing)
...
### 2. Xử lý giá trị ngoại lai (Outlier Treatment)
...
### 3. Kỹ nghệ tính năng (Feature Engineering)
...
## 📈 Kết Quả Phân Tích Lớn (Key Insights)
...
### 🎯 Xác định điểm đau (Baseline Task Analysis)
...
1. **Web Developers** (Điểm: 4.09/5)
2. **Computer User Support Specialists** (Điểm: 3.89/5)
3. **Computer Programmers** (Điểm: 3.84/5)
